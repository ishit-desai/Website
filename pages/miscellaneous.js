...
class MiscellaneousPage {
                        ...
                        <div class="product-modal-info-section">
                            ...
                            <div class="product-modal-contact-section">
                                ...
                                <div class="product-modal-contact-buttons">
                                    <a href="https://wa.me/919925648962?text=Hi, I'm interested in " class="product-contact-btn whatsapp-btn" id="miscModalWhatsAppBtn" target="_blank" rel="noopener">
                                    ...
                                    <a href="mailto:shrigurukrupa54@gmail.com?subject=Product Enquiry: " class="product-contact-btn email-btn" id="miscModalEmailBtn">
    ...
    init() {
        ...
        window.openMiscProductModal = (productId) => {
            ...
            const whatsappBtn = document.getElementById('miscModalWhatsAppBtn');
            const emailBtn = document.getElementById('miscModalEmailBtn');
